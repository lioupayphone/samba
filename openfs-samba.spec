...
install -m 0644 extra/samba.pamd %{buildroot}%{_sysconfdir}/pam.d/samba
...
install -m 0644 README.downgrade packaging/README.downgrade

%if ! %with_dc
install -m 0644 README.dc packaging/README.dc
install -m 0644 README.dc packaging/README.dc-libs
%endif
